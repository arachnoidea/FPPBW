...
<html>
<head>
<title>Sari Kedelai Shinta dan Oleh Oleh Khas Kediri | Price</title>
			...
			<a href="#" class="navicon"></a>
				<div class="toggle">
					<ul class="toggle-menu">
						...
						<li><a  class="active" href="<?php echo site_url('Home/menu');?>">Price</a></li>
			...
			<div class="menu-bottom animated wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="500ms">
				...
				<div class="col-md-4 menu-bottom1">
					<div class="btm-right">
							...
							<img src="<?php echo base_url($d['upload']);?>" alt="" class="img-responsive">
							<div class="captn">
								<h4><?= $d['nama_barang'] ?></h4>
								<p>Rp <?= $d['harga']?>,00</p>				
							</div>			
